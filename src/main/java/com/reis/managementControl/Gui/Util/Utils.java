...
public class Utils {
	...
	public static void formatComboBoxLocation(ComboBox<Location> location) {
		location.setConverter(new StringConverter<Location>() {
			...
			public Location fromString(String string) {
				...
				for(Location loc : location.getItems()) {
					if(loc.getName().equalsIgnoreCase(string)) {
						return loc;
					}
				}
				
				Location newLocation = new Location();
				newLocation.setName(string);
				return newLocation;
			}
		});
	}
