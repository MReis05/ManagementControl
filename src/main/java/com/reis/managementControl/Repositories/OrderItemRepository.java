...
public interface OrderItemRepository extends JpaRepository<OrderItem, OrderItemPK> {
	...
	@Query("SELECT new com.reis.managementControl.Entities.DTO.OrderItemHistoryDTO(o.id.product.name, SUM(o.quantity * o.unitValue), AVG(o.unitValue), o.id.product.category)"
